...
const ProductTile = () => {
  ...
  const products = useMemo(() => getProductsByCategory(category))
  ...
  return (
    <div>
      ...
      >
        ...
        >
          <div onClick={(e) => { e.stopPropagation(); navigate(`/product/ar/${products[0]._id}`) }} className='absolute top-4 right-4 w-fit h-fit p-2 rounded-full bg-white-light'>
          ...
          products.map((product, index) => index > 0 && (
            ...
            >
              ...
              >
                ...
                <div onClick={(e) => { e.stopPropagation(); navigate(`/product/ar/${product._id}`) }} className='absolute top-4 right-4 w-fit h-fit p-2 rounded-full bg-white-light'>
                  <FiBox color='black' fontSize={20} fontWeight={600} />
                </div>
                <div className='flex flex-col w-full bg-black bg-opacity-50 p-4 pt-2'>
